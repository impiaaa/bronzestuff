...
public class BronzeStuffMod {
	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		bronzeChestplate = new BronzeArmor(4643, config, "bronze_chestplate",
...
//				.setTextureName("bronze_horse_armor");
	...
	public void init(FMLInitializationEvent e) {
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzePickaxe, "III", " S ",
				" S ", 'I', "ingotBronze", 'S', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeAxe, "II", "IS", " S",
				'I', "ingotBronze", 'S', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeAxe, "II", "SI", "S ",
				'I', "ingotBronze", 'S', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeSword, "I", "I", "S",
				'I', "ingotBronze", 'S', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeShovel, "I", "S", "S",
				'I', "ingotBronze", 'S', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeHoe, "II", " S", " S",
				'I', "ingotBronze", 'S', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeHoe, "II", "S ", "S ",
				'I', "ingotBronze", 'S', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeHelmet, "III", "I I",
				'I', "ingotBronze"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeChestplate, "I I",
				"III", "III", 'I', "ingotBronze"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeLeggings, "III",
				"I I", "I I", 'I', "ingotBronze"));
		GameRegistry.addRecipe(new ShapedOreRecipe(bronzeBoots, "I I", "I I",
				'I', "ingotBronze"));
		...
		ChestGenHooks.addItem(ChestGenHooks.STRONGHOLD_CROSSING,
				new WeightedRandomChestContent(pickaxe, 1, 1, 1));
		WeightedRandomChestContent[] bronzeToolsArmor = {
		...
		for (WeightedRandomChestContent item : bronzeToolsArmor) {
